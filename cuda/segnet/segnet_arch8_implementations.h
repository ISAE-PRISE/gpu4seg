...
/*--------------------------- segnet_arch8_implementations.h ------------------------
|  File segnet_arch8_implementations.h
|
|  Description: Implementations of our 8th Segnet architecture 
|
|  Version: 1.0
*-----------------------------------------------------------------------------------*/

#ifndef SEGNET_ARCH8_IMPLEMENTATIONS_H_
#define SEGNET_ARCH8_IMPLEMENTATIONS_H_


//#define EVENT_RECORD_TIME 


/* SegnetImplementationOriginalTraditionalArch8
 *
 ...
 *
 * */
void SegnetImplementationOriginalTraditionalArch8(const dim3 &dimsImg, const dim3 &dimsFilter, const char INPUT_IMAGE_ADDR[], const char BIN_BASE_ADDR[], const char OUTPUT_IMAGE_ADDR[]){
  ...
  const unsigned NB_CONV_LAYER3 = 2;

  const unsigned CONV_2_LAYER[NB_CONVs] = {0, 0, 1, 1, 2, 2};
  ...
  unsigned pooled_index[NB_LAYERS] = {1, 3, 5};
...
/* SegnetImplementationIntegratedTraditionalArch8
 *
 * Description: Executes a modified Segnet CNN considering 3 enconder-decoder layers 
 ...
 *
 * */
void SegnetImplementationIntegratedTraditionalArch8(const dim3 &dimsImg, const dim3 &dimsFilter, const char INPUT_IMAGE_ADDR[], const char BIN_BASE_ADDR[], const char OUTPUT_IMAGE_ADDR[]){
...
/* SegnetImplementationOriginalWinograd2x2Arch8
 *
 ...
 *
 * */
void SegnetImplementationOriginalWinograd2x2Arch8(const dim3 &dimsImg, const dim3 &dimsFilter, const char INPUT_IMAGE_ADDR[], const char BIN_BASE_ADDR[], const char OUTPUT_IMAGE_ADDR[]){
 ...
 /* SegnetImplementationIntegratedWinograd2x2Arch8
 *
 * Description: Executes the Segnet CNN  enconder-decoder layers and output 
 *		 channels of 64, 128 and 256 and 2, 3 and 3 convolutions respectively.
 ...
 *
 * */
void SegnetImplementationIntegratedWinograd2x2Arch8(const dim3 &dimsImg, const dim3 &dimsFilter, const char INPUT_IMAGE_ADDR[], const char BIN_BASE_ADDR[], const char OUTPUT_IMAGE_ADDR[]){
